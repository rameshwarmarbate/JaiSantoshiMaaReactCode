...
export const lrStatusSlice = createSlice({
  name: "lrStatus",
  initialState,
  reducers: {},
...
export default lrStatusSlice.reducer;
export const selectIsLoading = (state) => state.lrstatus.status === "loading";
